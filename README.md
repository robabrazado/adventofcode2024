...
[Much later] I spent the time I could have spent on development today on taking notes, instead. The Day 21 solution is nowhere near functional at this point, but there are a *ton* of notes in there that should guide my future development (which isn't going to be tonight). Like genius, I buried much of it inside the `KeypadRobot` source, but I'll move it before the real part 1 commit.
